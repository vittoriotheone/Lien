...
const DEFIS = {
    doux: [
        ...
        "Envoyez-vous un message qui rappelle un souvenir drôle que vous partagez.",
        "Dessinez le portrait de l'autre en 2 minutes, sans regarder la feuille.",
        "Racontez le moment où vous avez compris que votre amitié allait compter.",
        "Prenez une photo qui représente votre amitié aujourd'hui.",
    ],
    fun: [
        ...
        "Créez un handshake secret rien qu'à vous deux.",
    ...
    profond: [
        ...
        "Discutez de ce que « réussir sa vie » veut dire pour chacun.",
        "Racontez un souvenir d'enfance qui explique qui vous êtes aujourd'hui.",
        "Parlez d'une chose que vous aimeriez pardonner, ou pour laquelle vous aimeriez être pardonné(e).",
        "Échangez sur ce que l'amitié représente pour chacun.",
        "Discutez d'un rêve que vous avez mis de côté.",
        "Parlez de ce qui peut vous faire vous sentir seul(e), même entouré(e).",
    ],
    epice: [
        "Écrivez-vous un petit mot sympa et glissez-le quelque part pour que l'autre le trouve.",
        "Offrez un massage de 5 minutes, sans rien demander en retour.",
        "Complimentez 3 qualités que vous appréciez chez l'autre.",
        "Planifiez une sortie surprise pour la semaine prochaine.",
        "Dites à l'autre ce que vous appréciez le plus chez lui/elle.",
        "Faites durer un câlin une minute complète, sans parler.",
        "Racontez votre souvenir le plus drôle à deux.",
        "Préparez une playlist qui représente votre amitié.",
    ],
};
const CATEGORIES = [
    { key: "doux", label: "Doux" },
...
function App() {
    ...
    async function handleCreate() {
        ...
        try {
            ...
            setError("Impossible de créer notre espace, réessaie.");
        }
        finally {
            setLoading(false);
        }
    ...
    function renderLanding() {
        return (React.createElement("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", paddingTop: 46, gap: 18 } },
            ...
            React.createElement("div", { style: { color: "#A79BC0", fontSize: 13.5, lineHeight: 1.6, maxWidth: 280 } }, "Un espace gratuit pour les meilleurs amis : questions du jour, jeux \u00E0 deux, d\u00E9fis et souvenirs partag\u00E9s."),
    ...
    function renderCreateName() {
        return (React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 14, paddingTop: 40 } },
            ...
            React.createElement("div", { style: { color: "#A79BC0", fontSize: 13.5 } }, "Ton pr\u00E9nom sera visible par ton/ta meilleur(e) ami(e)."),
    ...
    function renderCreatedCode() {
        return (React.createElement("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", gap: 14, paddingTop: 40 } },
            ...
            React.createElement("div", { style: { color: "#A79BC0", fontSize: 13.5, maxWidth: 260 } }, "Partage ce code avec ton/ta meilleur(e) ami(e) pour qu'iel rejoigne notre espace."),
    ...
    function renderJoinForm() {
        return (React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 14, paddingTop: 40 } },
            React.createElement("div", { className: "duo-display", style: { fontSize: 24, fontWeight: 600 } }, "Rejoindre notre espace"),
    ...
    function renderAccueil() {
        ...
        if (bothAnswered)
            daylinkStatus = "Nous avons tous les deux répondu — découvrons nos réponses.";
        else if (iAnswered)
            daylinkStatus = "Réponse envoyée. En attente de " + (partnerName || "ton/ta meilleur(e) ami(e)") + ".";
        return (React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 16, padding: "4px 20px 20px" } },
            ...
            !data.members.B && (React.createElement("div", { className: "duo-card", style: { padding: 16 } },
                React.createElement("div", { style: { fontSize: 13.5, fontWeight: 600, marginBottom: 6, display: "flex", alignItems: "center", gap: 6 } },
                    ...
                    " Invite ton/ta meilleur(e) ami(e)"),
                React.createElement("div", { style: { fontSize: 12.5, color: "#A79BC0", marginBottom: 10 } }, "Partage ce code pour qu'iel rejoigne notre espace."),
            ...
            React.createElement("div", { style: { fontSize: 11, color: "#A79BC0", textAlign: "center", lineHeight: 1.5, marginTop: 4 } },
                "Nos r\u00E9ponses sont sauvegard\u00E9es automatiquement sur cet appareil, sous le code ",
                code,
                ".")));
    }
        ...
        return (React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 16, padding: "4px 20px 20px" } },
            ...
            iAnswered && !bothAnswered && (React.createElement("div", { className: "duo-card", style: { padding: 18, display: "flex", flexDirection: "column", gap: 14, alignItems: "center" } },
                ...
                React.createElement("div", { style: { fontSize: 12.5, color: "#A79BC0", textAlign: "center" } },
                    ...
                    partnerName || "ton/ta meilleur(e) ami(e)",
                    "..."))),
            ...
            pastDays.length > 0 && (React.createElement("div", null,
                React.createElement("div", { style: { fontSize: 12.5, fontWeight: 600, color: "#A79BC0", margin: "6px 0 10px" } }, "Nos derniers liens"),
    ...
    function renderQui() {
        ...
        return (React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 16, padding: "4px 4px 20px" } },
            ...
            !bothVoted ? (React.createElement("div", { style: { display: "flex", gap: 10 } },
                React.createElement("button", { className: "duo-btn-ghost", style: { flex: 1, borderColor: myVote === "A" ? "#FF8B66" : undefined, opacity: myVote ? (myVote === "A" ? 1 : 0.5) : 1 }, disabled: !!myVote, onClick: () => voteQui("A") }, mySlot === "A" ? myName : (partnerName || "Ami A")),
                React.createElement("button", { className: "duo-btn-ghost", style: { flex: 1, borderColor: myVote === "B" ? "#FF8B66" : undefined, opacity: myVote ? (myVote === "B" ? 1 : 0.5) : 1 }, disabled: !!myVote, onClick: () => voteQui("B") }, mySlot === "B" ? myName : (partnerName || "Ami B")))) : (React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 12, alignItems: "center" } },
                React.createElement("div", { style: { fontSize: 14, fontWeight: 600, display: "flex", alignItems: "center", gap: 6 } }, qui.votes.A === qui.votes.B ? React.createElement(React.Fragment, null,
                    ...
                    " Nous sommes d'accord") : "Avis partagés 👀"),
    ...
    function renderTuPrefere() {
        ...
        return (React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 14, padding: "4px 4px 20px" } },
            ...
            bothVoted && (React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 10, alignItems: "center", marginTop: 4 } },
                React.createElement("div", { style: { fontSize: 13.5, fontWeight: 600 } }, tp.votes.A === tp.votes.B ? "Même choix ❤️" : "Nous sommes différents, et c'est ok 😄"),
        ...
        return (React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 16, padding: "4px 20px 20px" } },
            React.createElement("div", { className: "duo-card", style: { padding: 16, display: "flex", flexDirection: "column", gap: 10 } },
                ...
                React.createElement("button", { className: "duo-btn-primary", disabled: !souvenirTitle.trim(), onClick: addSouvenir, style: { display: "flex", alignItems: "center", justifyContent: "center", gap: 8 } },
                    ...
                    " Ajouter au journal")),
            list.length === 0 ? (React.createElement("div", { style: { fontSize: 12.5, color: "#A79BC0", textAlign: "center", padding: "10px 20px" } }, "Notre histoire commence ici. Ajoutons notre premier souvenir.")) : (React.createElement("div", { style: { display: "flex", flexDirection: "column" } }, list.map((s, i) => (React.createElement("div", { key: s.id, style: { display: "flex", gap: 12 } },
