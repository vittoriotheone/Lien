...
function App() {
    ...
    function renderChat() {
        ...
        return React.createElement("div", { style: { position: "absolute", left: 12, right: 12, bottom: 78, height: "62%", zIndex: 30, background: "rgba(24,16,40,0.98)", border: "1px solid rgba(244,199,123,0.2)", borderRadius: 24, boxShadow: "0 24px 60px rgba(0,0,0,.55)", display: "flex", flexDirection: "column", overflow: "hidden", backdropFilter: "blur(18px)" } },
            React.createElement("div", { style: { padding: "14px 16px", display: "flex", alignItems: "center", justifyContent: "space-between", borderBottom: "1px solid rgba(167,155,192,.18)" } },
                React.createElement("div", null,
            ...
            React.createElement("div", { className: "duo-scroll", style: { flex: 1, overflowY: "auto", padding: 14, display: "flex", flexDirection: "column", gap: 8 } },
            ...
            React.createElement("div", { style: { padding: 10, borderTop: "1px solid rgba(167,155,192,.18)", display: "flex", gap: 8 } },
