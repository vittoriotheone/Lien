...
async function getMainSpace() {
    ...
    const initial = { createdAt: Date.now(), members: { A: "Victor", B: "Marianne" }, score: 0, streak: 0, lastActiveDate: null, daylink: {}, qui: null, tuprefere: null, defis: { log: [], current: null }, souvenirs: [] };
    await setCouple(MAIN_SPACE_FALLBACK_CODE, initial);
    return { code: MAIN_SPACE_FALLBACK_CODE, data: initial };
}
function emptyMainData() {
    return { createdAt: Date.now(), members: { A: "Victor", B: "Marianne" }, score: 0, streak: 0, lastActiveDate: null, daylink: {}, qui: null, tuprefere: null, defis: { log: [], current: null }, souvenirs: [] };
}
/* ------------------------------------------------------------------ */
...
function App() {
    ...
    function renderLanding() {
        return (React.createElement("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", paddingTop: 46, gap: 18 } },
            ...
            React.createElement("div", { style: { color: "#A79BC0", fontSize: 13.5, lineHeight: 1.6, maxWidth: 280 } }, "Choisis simplement notre profil pour entrer dans notre espace."),
            React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 10, width: "100%", marginTop: 10 } },
                React.createElement("button", { className: "duo-btn-primary", disabled: loading, onClick: () => handleLogin("Victor") }, loading ? "Connexion..." : "Victor"),
                React.createElement("button", { className: "duo-btn-ghost", disabled: loading, onClick: () => handleLogin("Marianne") }, "Marianne"),
