...
function App() {
    ...
    function renderJeux() {
        const subs = [{ key: "qui", label: "Qui de nous deux" }, { key: "tu", label: "Tu préfères" }, { key: "av", label: "Action ou Vérité" }, { key: "defis", label: "Défis" }, { key: "custom", label: "Nos questions" }];
        return (React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 14, padding: "4px 20px 0" } },
            ...
            gameSub === "custom" && renderPersonnalise()));
    }
