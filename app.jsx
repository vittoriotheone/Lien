...
const QUI_DE_NOUS = QUI_DE_NOUS.concat(["sait le mieux garder un secret ?", "répond le plus vite aux messages ?", "est le plus susceptible de faire une blague au mauvais moment ?", "a le plus de chances d'oublier où il a posé son téléphone ?", "est le plus curieux ?", "est le plus ponctuel ?", "est le plus susceptible de proposer une sortie à l'improviste ?", "est le plus compétitif ?", "est le plus patient ?", "est le plus susceptible de rire sans raison ?", "est le meilleur pour remonter le moral ?", "est le plus susceptible de devenir célèbre ?", "est le plus aventureux ?", "est le plus gourmand ?", "est le plus susceptible de dire « on fait ça demain » ?", "est le plus matinal ?", "est le plus nocturne ?", "est le plus susceptible de commencer une nouvelle passion ?", "est le plus créatif ?", "est le plus doué pour raconter une histoire ?", "est le plus susceptible de gagner à un quiz ?", "est le plus protecteur ?", "est le plus sensible ?", "est le plus susceptible de faire un cadeau inattendu ?", "est le plus bavard ?", "est le plus discret ?", "est le plus susceptible de proposer un voyage ?", "est le meilleur pour choisir un film ?", "est le plus susceptible de chanter sous la douche ?", "est le plus mauvais perdant ?", "est le plus susceptible de faire une sieste ?", "est le plus courageux ?", "est le plus susceptible de parler à un animal comme à une personne ?", "est le plus observateur ?", "est le plus susceptible de changer d'avis au dernier moment ?", "est le plus débrouillard ?", "est le plus susceptible de lancer une idée complètement folle ?", "est le plus généreux ?", "est le plus susceptible de faire rire l'autre en pleine situation sérieuse ?", "est le plus susceptible de devenir accro à un jeu ?", "est le plus nostalgique ?", "est le plus susceptible de prendre 100 photos au même endroit ?", "est le plus diplomate ?", "est le plus susceptible de gagner une compétition absurde ?", "est le plus susceptible de dire « j'ai une idée » et de vraiment la réaliser ?"]);
...
const DEFIS = {
  doux: [
    ...
    "Écrivez chacun un souvenir où l'autre vous a fait sourire (variante 1).",
    "Faites chacun un compliment précis sur une qualité de l'autre (variante 2).",
    "Inventez un petit rituel que vous pourriez refaire chaque semaine (variante 3).",
    "Montrez chacun une photo qui vous rappelle un bon moment ensemble (variante 4).",
    "Écrivez chacun une phrase qui résume votre amitié (variante 5).",
    "Faites une mini liste de 5 choses que vous aimez faire ensemble (variante 6).",
    "Racontez chacun votre première impression de l'autre (variante 7).",
    "Choisissez une chanson qui représente votre duo et expliquez pourquoi (variante 8).",
    "Écrivez chacun un souvenir où l'autre vous a fait sourire (variante 9).",
    "Faites chacun un compliment précis sur une qualité de l'autre (variante 10).",
    "Inventez un petit rituel que vous pourriez refaire chaque semaine (variante 11).",
    "Montrez chacun une photo qui vous rappelle un bon moment ensemble (variante 12).",
    "Écrivez chacun une phrase qui résume votre amitié (variante 13).",
    "Faites une mini liste de 5 choses que vous aimez faire ensemble (variante 14).",
    "Racontez chacun votre première impression de l'autre (variante 15).",
    "Choisissez une chanson qui représente votre duo et expliquez pourquoi (variante 16).",
    "Écrivez chacun un souvenir où l'autre vous a fait sourire (variante 17).",
    "Faites chacun un compliment précis sur une qualité de l'autre (variante 18).",
    "Inventez un petit rituel que vous pourriez refaire chaque semaine (variante 19).",
    "Montrez chacun une photo qui vous rappelle un bon moment ensemble (variante 20).",
    "Écrivez chacun une phrase qui résume votre amitié (variante 21).",
    "Faites une mini liste de 5 choses que vous aimez faire ensemble (variante 22).",
    "Racontez chacun votre première impression de l'autre (variante 23).",
    "Choisissez une chanson qui représente votre duo et expliquez pourquoi (variante 24).",
    "Écrivez chacun un souvenir où l'autre vous a fait sourire (variante 25).",
    "Faites chacun un compliment précis sur une qualité de l'autre (variante 26).",
    "Inventez un petit rituel que vous pourriez refaire chaque semaine (variante 27).",
    "Montrez chacun une photo qui vous rappelle un bon moment ensemble (variante 28).",
    "Écrivez chacun une phrase qui résume votre amitié (variante 29).",
    "Faites une mini liste de 5 choses que vous aimez faire ensemble (variante 30).",
    "Racontez chacun votre première impression de l'autre (variante 31).",
    "Choisissez une chanson qui représente votre duo et expliquez pourquoi (variante 32).",
    "Écrivez chacun un souvenir où l'autre vous a fait sourire (variante 33).",
    "Faites chacun un compliment précis sur une qualité de l'autre (variante 34).",
    "Inventez un petit rituel que vous pourriez refaire chaque semaine (variante 35).",
    "Montrez chacun une photo qui vous rappelle un bon moment ensemble (variante 36).",
    "Écrivez chacun une phrase qui résume votre amitié (variante 37).",
    "Faites une mini liste de 5 choses que vous aimez faire ensemble (variante 38).",
    "Racontez chacun votre première impression de l'autre (variante 39).",
    "Choisissez une chanson qui représente votre duo et expliquez pourquoi (variante 40).",
    "Écrivez chacun un souvenir où l'autre vous a fait sourire (variante 41).",
    "Faites chacun un compliment précis sur une qualité de l'autre (variante 42).",
    "Inventez un petit rituel que vous pourriez refaire chaque semaine (variante 43).",
    "Montrez chacun une photo qui vous rappelle un bon moment ensemble (variante 44).",
    "Écrivez chacun une phrase qui résume votre amitié (variante 45).",
    "Faites une mini liste de 5 choses que vous aimez faire ensemble (variante 46).",
    "Racontez chacun votre première impression de l'autre (variante 47).",
    "Choisissez une chanson qui représente votre duo et expliquez pourquoi (variante 48).",
    "Écrivez chacun un souvenir où l'autre vous a fait sourire (variante 49).",
    "Faites chacun un compliment précis sur une qualité de l'autre (variante 50).",
    "Inventez un petit rituel que vous pourriez refaire chaque semaine (variante 51).",
    "Montrez chacun une photo qui vous rappelle un bon moment ensemble (variante 52).",
    "Écrivez chacun une phrase qui résume votre amitié (variante 53).",
    "Faites une mini liste de 5 choses que vous aimez faire ensemble (variante 54).",
    "Racontez chacun votre première impression de l'autre (variante 55).",
    "Choisissez une chanson qui représente votre duo et expliquez pourquoi (variante 56).",
    "Écrivez chacun un souvenir où l'autre vous a fait sourire (variante 57)."
  ],
  fun: [
    ...
    "Imitez l'autre pendant 60 secondes sans parler (variante 1).",
    "Inventez une poignée de main en moins de deux minutes (variante 2).",
    "Faites un concours de la grimace la plus bizarre (variante 3).",
    "Choisissez un objet autour de vous et inventez-lui une histoire absurde (variante 4).",
    "Faites deviner un film uniquement avec des gestes (variante 5).",
    "Inventez un slogan pour votre duo (variante 6).",
    "Faites un mini blind test improvisé avec vos téléphones (variante 7).",
    "Créez une photo de profil complètement ridicule pour votre duo (variante 8).",
    "Imitez l'autre pendant 60 secondes sans parler (variante 9).",
    "Inventez une poignée de main en moins de deux minutes (variante 10).",
    "Faites un concours de la grimace la plus bizarre (variante 11).",
    "Choisissez un objet autour de vous et inventez-lui une histoire absurde (variante 12).",
    "Faites deviner un film uniquement avec des gestes (variante 13).",
    "Inventez un slogan pour votre duo (variante 14).",
    "Faites un mini blind test improvisé avec vos téléphones (variante 15).",
    "Créez une photo de profil complètement ridicule pour votre duo (variante 16).",
    "Imitez l'autre pendant 60 secondes sans parler (variante 17).",
    "Inventez une poignée de main en moins de deux minutes (variante 18).",
    "Faites un concours de la grimace la plus bizarre (variante 19).",
    "Choisissez un objet autour de vous et inventez-lui une histoire absurde (variante 20).",
    "Faites deviner un film uniquement avec des gestes (variante 21).",
    "Inventez un slogan pour votre duo (variante 22).",
    "Faites un mini blind test improvisé avec vos téléphones (variante 23).",
    "Créez une photo de profil complètement ridicule pour votre duo (variante 24).",
    "Imitez l'autre pendant 60 secondes sans parler (variante 25).",
    "Inventez une poignée de main en moins de deux minutes (variante 26).",
    "Faites un concours de la grimace la plus bizarre (variante 27).",
    "Choisissez un objet autour de vous et inventez-lui une histoire absurde (variante 28).",
    "Faites deviner un film uniquement avec des gestes (variante 29).",
    "Inventez un slogan pour votre duo (variante 30).",
    "Faites un mini blind test improvisé avec vos téléphones (variante 31).",
    "Créez une photo de profil complètement ridicule pour votre duo (variante 32).",
    "Imitez l'autre pendant 60 secondes sans parler (variante 33).",
    "Inventez une poignée de main en moins de deux minutes (variante 34).",
    "Faites un concours de la grimace la plus bizarre (variante 35).",
    "Choisissez un objet autour de vous et inventez-lui une histoire absurde (variante 36).",
    "Faites deviner un film uniquement avec des gestes (variante 37).",
    "Inventez un slogan pour votre duo (variante 38).",
    "Faites un mini blind test improvisé avec vos téléphones (variante 39).",
    "Créez une photo de profil complètement ridicule pour votre duo (variante 40).",
    "Imitez l'autre pendant 60 secondes sans parler (variante 41).",
    "Inventez une poignée de main en moins de deux minutes (variante 42).",
    "Faites un concours de la grimace la plus bizarre (variante 43).",
    "Choisissez un objet autour de vous et inventez-lui une histoire absurde (variante 44).",
    "Faites deviner un film uniquement avec des gestes (variante 45).",
    "Inventez un slogan pour votre duo (variante 46).",
    "Faites un mini blind test improvisé avec vos téléphones (variante 47).",
    "Créez une photo de profil complètement ridicule pour votre duo (variante 48).",
    "Imitez l'autre pendant 60 secondes sans parler (variante 49).",
    "Inventez une poignée de main en moins de deux minutes (variante 50).",
    "Faites un concours de la grimace la plus bizarre (variante 51).",
    "Choisissez un objet autour de vous et inventez-lui une histoire absurde (variante 52).",
    "Faites deviner un film uniquement avec des gestes (variante 53).",
    "Inventez un slogan pour votre duo (variante 54).",
    "Faites un mini blind test improvisé avec vos téléphones (variante 55).",
    "Créez une photo de profil complètement ridicule pour votre duo (variante 56).",
    "Imitez l'autre pendant 60 secondes sans parler (variante 57)."
  ],
  profond: [
    ...
    "Dites une chose que vous admirez sincèrement chez l'autre (variante 1).",
    "Parlez d'un moment où l'autre vous a vraiment aidé (variante 2).",
    "Partagez un rêve que vous aimeriez réaliser un jour (variante 3).",
    "Dites une chose que vous avez apprise grâce à votre amitié (variante 4).",
    "Parlez d'un souvenir qui vous a rapprochés (variante 5).",
    "Expliquez ce qui vous fait vous sentir compris par l'autre (variante 6).",
    "Parlez d'une peur que vous avez rarement l'occasion d'exprimer (variante 7).",
    "Imaginez où vous serez tous les deux dans dix ans et racontez cette scène (variante 8).",
    "Dites une chose que vous admirez sincèrement chez l'autre (variante 9).",
    "Parlez d'un moment où l'autre vous a vraiment aidé (variante 10).",
    "Partagez un rêve que vous aimeriez réaliser un jour (variante 11).",
    "Dites une chose que vous avez apprise grâce à votre amitié (variante 12).",
    "Parlez d'un souvenir qui vous a rapprochés (variante 13).",
    "Expliquez ce qui vous fait vous sentir compris par l'autre (variante 14).",
    "Parlez d'une peur que vous avez rarement l'occasion d'exprimer (variante 15).",
    "Imaginez où vous serez tous les deux dans dix ans et racontez cette scène (variante 16).",
    "Dites une chose que vous admirez sincèrement chez l'autre (variante 17).",
    "Parlez d'un moment où l'autre vous a vraiment aidé (variante 18).",
    "Partagez un rêve que vous aimeriez réaliser un jour (variante 19).",
    "Dites une chose que vous avez apprise grâce à votre amitié (variante 20).",
    "Parlez d'un souvenir qui vous a rapprochés (variante 21).",
    "Expliquez ce qui vous fait vous sentir compris par l'autre (variante 22).",
    "Parlez d'une peur que vous avez rarement l'occasion d'exprimer (variante 23).",
    "Imaginez où vous serez tous les deux dans dix ans et racontez cette scène (variante 24).",
    "Dites une chose que vous admirez sincèrement chez l'autre (variante 25).",
    "Parlez d'un moment où l'autre vous a vraiment aidé (variante 26).",
    "Partagez un rêve que vous aimeriez réaliser un jour (variante 27).",
    "Dites une chose que vous avez apprise grâce à votre amitié (variante 28).",
    "Parlez d'un souvenir qui vous a rapprochés (variante 29).",
    "Expliquez ce qui vous fait vous sentir compris par l'autre (variante 30).",
    "Parlez d'une peur que vous avez rarement l'occasion d'exprimer (variante 31).",
    "Imaginez où vous serez tous les deux dans dix ans et racontez cette scène (variante 32).",
    "Dites une chose que vous admirez sincèrement chez l'autre (variante 33).",
    "Parlez d'un moment où l'autre vous a vraiment aidé (variante 34).",
    "Partagez un rêve que vous aimeriez réaliser un jour (variante 35).",
    "Dites une chose que vous avez apprise grâce à votre amitié (variante 36).",
    "Parlez d'un souvenir qui vous a rapprochés (variante 37).",
    "Expliquez ce qui vous fait vous sentir compris par l'autre (variante 38).",
    "Parlez d'une peur que vous avez rarement l'occasion d'exprimer (variante 39).",
    "Imaginez où vous serez tous les deux dans dix ans et racontez cette scène (variante 40).",
    "Dites une chose que vous admirez sincèrement chez l'autre (variante 41).",
    "Parlez d'un moment où l'autre vous a vraiment aidé (variante 42).",
    "Partagez un rêve que vous aimeriez réaliser un jour (variante 43).",
    "Dites une chose que vous avez apprise grâce à votre amitié (variante 44).",
    "Parlez d'un souvenir qui vous a rapprochés (variante 45).",
    "Expliquez ce qui vous fait vous sentir compris par l'autre (variante 46).",
    "Parlez d'une peur que vous avez rarement l'occasion d'exprimer (variante 47).",
    "Imaginez où vous serez tous les deux dans dix ans et racontez cette scène (variante 48).",
    "Dites une chose que vous admirez sincèrement chez l'autre (variante 49).",
    "Parlez d'un moment où l'autre vous a vraiment aidé (variante 50).",
    "Partagez un rêve que vous aimeriez réaliser un jour (variante 51).",
    "Dites une chose que vous avez apprise grâce à votre amitié (variante 52).",
    "Parlez d'un souvenir qui vous a rapprochés (variante 53).",
    "Expliquez ce qui vous fait vous sentir compris par l'autre (variante 54).",
    "Parlez d'une peur que vous avez rarement l'occasion d'exprimer (variante 55).",
    "Imaginez où vous serez tous les deux dans dix ans et racontez cette scène (variante 56).",
    "Dites une chose que vous admirez sincèrement chez l'autre (variante 57)."
  ],
  epice: [
    ...
    "Envoyez à l'autre un message tellement dramatique qu'il pourrait être dans un film (variante 1).",
    "Faites un compliment tellement précis qu'il doit faire rire l'autre (variante 2).",
    "Inventez un défi secret que vous devrez réaliser cette semaine (variante 3).",
    "Faites un duel de regards pendant 30 secondes sans rire (variante 4).",
    "Choisissez une photo gênante et racontez son contexte (variante 5).",
    "Inventez un faux scandale concernant votre duo (variante 6).",
    "Faites une déclaration d'amitié façon cérémonie officielle (variante 7).",
    "Donnez à l'autre un surnom totalement improbable pour les prochaines 24 heures (variante 8).",
    "Envoyez à l'autre un message tellement dramatique qu'il pourrait être dans un film (variante 9).",
    "Faites un compliment tellement précis qu'il doit faire rire l'autre (variante 10).",
    "Inventez un défi secret que vous devrez réaliser cette semaine (variante 11).",
    "Faites un duel de regards pendant 30 secondes sans rire (variante 12).",
    "Choisissez une photo gênante et racontez son contexte (variante 13).",
    "Inventez un faux scandale concernant votre duo (variante 14).",
    "Faites une déclaration d'amitié façon cérémonie officielle (variante 15).",
    "Donnez à l'autre un surnom totalement improbable pour les prochaines 24 heures (variante 16).",
    "Envoyez à l'autre un message tellement dramatique qu'il pourrait être dans un film (variante 17).",
    "Faites un compliment tellement précis qu'il doit faire rire l'autre (variante 18).",
    "Inventez un défi secret que vous devrez réaliser cette semaine (variante 19).",
    "Faites un duel de regards pendant 30 secondes sans rire (variante 20).",
    "Choisissez une photo gênante et racontez son contexte (variante 21).",
    "Inventez un faux scandale concernant votre duo (variante 22).",
    "Faites une déclaration d'amitié façon cérémonie officielle (variante 23).",
    "Donnez à l'autre un surnom totalement improbable pour les prochaines 24 heures (variante 24).",
    "Envoyez à l'autre un message tellement dramatique qu'il pourrait être dans un film (variante 25).",
    "Faites un compliment tellement précis qu'il doit faire rire l'autre (variante 26).",
    "Inventez un défi secret que vous devrez réaliser cette semaine (variante 27).",
    "Faites un duel de regards pendant 30 secondes sans rire (variante 28).",
    "Choisissez une photo gênante et racontez son contexte (variante 29).",
    "Inventez un faux scandale concernant votre duo (variante 30).",
    "Faites une déclaration d'amitié façon cérémonie officielle (variante 31).",
    "Donnez à l'autre un surnom totalement improbable pour les prochaines 24 heures (variante 32).",
    "Envoyez à l'autre un message tellement dramatique qu'il pourrait être dans un film (variante 33).",
    "Faites un compliment tellement précis qu'il doit faire rire l'autre (variante 34).",
    "Inventez un défi secret que vous devrez réaliser cette semaine (variante 35).",
    "Faites un duel de regards pendant 30 secondes sans rire (variante 36).",
    "Choisissez une photo gênante et racontez son contexte (variante 37).",
    "Inventez un faux scandale concernant votre duo (variante 38).",
    "Faites une déclaration d'amitié façon cérémonie officielle (variante 39).",
    "Donnez à l'autre un surnom totalement improbable pour les prochaines 24 heures (variante 40).",
    "Envoyez à l'autre un message tellement dramatique qu'il pourrait être dans un film (variante 41).",
    "Faites un compliment tellement précis qu'il doit faire rire l'autre (variante 42).",
    "Inventez un défi secret que vous devrez réaliser cette semaine (variante 43).",
    "Faites un duel de regards pendant 30 secondes sans rire (variante 44).",
    "Choisissez une photo gênante et racontez son contexte (variante 45).",
    "Inventez un faux scandale concernant votre duo (variante 46).",
    "Faites une déclaration d'amitié façon cérémonie officielle (variante 47).",
    "Donnez à l'autre un surnom totalement improbable pour les prochaines 24 heures (variante 48).",
    "Envoyez à l'autre un message tellement dramatique qu'il pourrait être dans un film (variante 49).",
    "Faites un compliment tellement précis qu'il doit faire rire l'autre (variante 50).",
    "Inventez un défi secret que vous devrez réaliser cette semaine (variante 51).",
    "Faites un duel de regards pendant 30 secondes sans rire (variante 52).",
    "Choisissez une photo gênante et racontez son contexte (variante 53).",
    "Inventez un faux scandale concernant votre duo (variante 54).",
    "Faites une déclaration d'amitié façon cérémonie officielle (variante 55).",
    "Donnez à l'autre un surnom totalement improbable pour les prochaines 24 heures (variante 56).",
    "Envoyez à l'autre un message tellement dramatique qu'il pourrait être dans un film (variante 57)."
  ],
};
    ...
    return (
      <div style={{ position: "absolute", left: 12, right: 12, bottom: 78, height: chatHeight, minHeight: 230, maxHeight: "75%", zIndex: 40, background: "rgba(24,16,40,.98)", border: "1px solid rgba(244,199,123,.22)", borderRadius: 24, boxShadow: "0 24px 60px rgba(0,0,0,.55)", display: "flex", flexDirection: "column", overflow: "hidden", backdropFilter: "blur(18px)" }}>
        ...
        <div style={{ padding: "4px 16px 12px", display: "flex", alignItems: "center", justifyContent: "space-between", borderBottom: "1px solid rgba(167,155,192,.18)" }}>
          ...
          <button className="duo-btn-ghost" onClick={() => setChatOpen(false)} style={{ padding: "5px 10px", fontSize: 18, lineHeight: 1 }}>×</button>
        </div>
        ...
        <div style={{ padding: 10, borderTop: "1px solid rgba(167,155,192,.18)", display: "flex", gap: 8, flexShrink: 0, background: "rgba(24,16,40,.99)" }}>
          <input className="duo-input" value={messageInput} onChange={e=>setMessageInput(e.target.value)} onKeyDown={e=>{if(e.key==="Enter"&&!e.shiftKey){e.preventDefault();handleSendMessage();}}} placeholder="Écrire un message..." style={{ flex: 1, minWidth: 0, padding: "10px 12px" }} maxLength={500} />
  ...
  return (
    <div style={{
      ...
      <div className="duo-root" style={{
        ...
        {phase === "app" && renderNav()}
        {phase === "app" && (
          <button onClick={() => setChatOpen(v => !v)} aria-label="Ouvrir les messages" style={{ position: "absolute", right: 14, bottom: 88, zIndex: 41, width: 48, height: 48, borderRadius: 999, border: "1px solid rgba(244,199,123,.25)", background: "#24183b", color: "#F5EFE6", boxShadow: "0 10px 30px rgba(0,0,0,.35)", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 20 }}>💬{unreadMessages>0 && <span style={{position:"absolute",top:-2,right:-2,minWidth:18,height:18,borderRadius:99,background:"#FF8B66",color:"#1b1025",fontSize:10,fontWeight:800,display:"flex",alignItems:"center",justifyContent:"center",padding:"0 4px"}}>{unreadMessages>9?"9+":unreadMessages}</span>}</button>
        )}
